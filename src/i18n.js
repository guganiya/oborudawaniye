...
const resources = {
	en: {
		translation: {
			...
			footer_copyright: '© 2026 LUMINA LIGHTING PRO. ALL RIGHTS RESERVED.',
	...
	ru: {
		translation: {
			...
			footer_link_sustainability: 'Устойчивое развитие',
			...
			footer_copyright: '© 2026 LUMINA LIGHTING PRO. ВСЕ ПРАВА ЗАЩИЩЕНЫ.',
	...
	tk: {
		translation: {
			...
			footer_link_sustainability: 'Durnukly ösüş',
			footer_link_innovation: 'Innowasiýa',
			footer_link_careers: 'Kariýera',
			...
			footer_copyright: '© 2026 LUMINA LIGHTING PRO. ÄHLI HUKUKLAR GORALANDYR.',
