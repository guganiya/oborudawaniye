...
const Products = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-[#e21e26] selection:text-white">
      ...
      {/* --- HERO SLIDER HEADER --- */}
      <header className="relative h-[80vh] min-h-[600px] mt-30 w-full overflow-hidden bg-black">
    ...
    >
      ...
      >
        ...
        <div className="relative aspect-[4/5] overflow-hidden rounded-[5px] bg-gray-100 border border-gray-200/80 shadow-sm transition-all duration-500 group-hover:border-[#e21e26]/40 group-hover:shadow-2xl">
          ...
          <div
            className="absolute inset-0 bg-gradient-to-b from-black/0 via-black/10 to-black/60 transition-opacity duration-500 group-hover:opacity-80"
            aria-hidden="true"
          />
